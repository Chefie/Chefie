...
class ProfilePicCellView : BaseCell, ICellDataProtocol{
    ...
    override func onLayout(size : CGSize!) {
        ...
        let cellSize = CGSize(width: size.width, height: size.heightPercentageOf(amount: 33))
        ...
        profilePic.snp.makeConstraints { (maker) in
            ...
            maker.width.equalTo(cellSize.widthPercentageOf(amount: 45))
            maker.height.equalTo(cellSize.heightPercentageOf(amount: 50))
